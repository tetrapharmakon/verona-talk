...
\begin{frame}{Formal $\infty$-category theory}
	...
	\onslide<2-> The Yoneda structure is \alert{representable} by an object $\mathbb{S}$ (the $\infty$-category of spaces) that \emph{classifies opfibrations}: the $\infty$-category of spaces. 
